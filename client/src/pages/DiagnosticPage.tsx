...
export default function DiagnosticPage() {
  ...
  const isApiUrlCorrect = apiUrl === 'https://api.solventusgroup.com';
          ...
          <div className="space-y-3">
            ...
            <div className="bg-muted/50 rounded-lg p-4">
              ...
              <ul className="text-sm space-y-1 ml-4 list-disc">
                ...
                <li>Failed to fetch → Vérifier que api.solventusgroup.com est accessible</li>
              ...
              <li className="flex gap-3">
                ...
                <div>
                  ...
                  <code className="block mt-1 bg-background px-2 py-1 rounded text-xs">
                    VITE_API_URL = https://api.solventusgroup.com
                  </code>
                </div>
              </li>
