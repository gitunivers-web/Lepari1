...
export default function Auth() {
  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen bg-white dark:bg-slate-950 overflow-hidden">
      ...
      <div className="absolute w-[500px] h-[500px] bg-gradient-to-br from-solventus-purple to-solventus-blue opacity-20 dark:opacity-10 rounded-full blur-3xl animate-float top-10 left-10" />
      <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-gradient-to-tr from-solventus-blue to-solventus-purple opacity-20 dark:opacity-10 rounded-full blur-3xl animate-float" style={{ animationDelay: '-9s' }} />
            ...
            <form onSubmit={loginForm.handleSubmit(onLoginSubmit)} className="space-y-5">
              ...
              <div className="text-right">
                <Link href="/forgot-password">
                  <button
                    type="button"
                    className="text-sm text-solventus-blue hover:text-solventus-purple font-medium transition-colors"
              ...
              <Button
                ...
                className="w-full bg-solventus-blue hover:bg-solventus-purple text-white py-3 rounded-lg font-bold relative overflow-hidden group transition-all"
          ...
          <Form {...signupForm}>
            <form onSubmit={signupForm.handleSubmit(onSignupSubmit)} className="space-y-5">
                    ...
                    <FormControl>
                      ...
                      >
                        <div>
                          ...
                          <Label
                            htmlFor="personal"
                            className="flex flex-col items-center justify-center border-2 border-gray-300 dark:border-slate-600 bg-gray-50 dark:bg-slate-800 rounded-lg p-4 cursor-pointer transition-all peer-data-[state=checked]:border-solventus-blue peer-data-[state=checked]:bg-solventus-blue/10 dark:peer-data-[state=checked]:bg-solventus-blue/20"
                            data-testid="label-personal"
                          >
                            <FaUser className="text-3xl mb-2 text-solventus-blue" />
                        ...
                        <div>
                          ...
                          >
                            <FaBuilding className="text-3xl mb-2 text-solventus-blue" />
              ...
              {accountType === 'business' && (
                <div className="space-y-4 p-4 bg-solventus-blue/5 dark:bg-solventus-blue/10 rounded-lg border border-solventus-blue/30 dark:border-solventus-blue/30">
                  <FormField
                    control={signupForm.control}
                    name="companyName"
                    render={({ field }) => (
