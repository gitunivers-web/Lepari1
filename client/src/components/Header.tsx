...
export default function Header() {
  ...
  return (
    ...
    ">
      ...
      {/* MOBILE MENU */}
      {mobileMenuOpen && (
        <div className="lg:hidden absolute top-20 left-0 w-full bg-white dark:bg-slate-900 border-b border-gray-200 dark:border-slate-700 shadow-lg">
          <div className="py-4 px-6">
            <nav className="flex flex-col space-y-2">
              ...
              >
                <Button 
                  className="w-full bg-altus-blue hover:bg-altus-purple text-white font-semibold"
                >
                  <span className="relative z-10">{t.hero.cta2}</span>
                </Button>
              </Link>
