...
async function sendEmail(options: {
  ...
  sendSmtpEmail.sender = { email: options.from, name: 'SOLVENTUS GROUP' };
...
export async function sendResetPasswordEmail(toEmail: string, fullName: string, token: string, language: string = 'fr') {
  try {
    ...
    const subject = language === 'en' 
      ? 'Reset your password - SOLVENTUS GROUP'
      : 'Réinitialisez votre mot de passe - SOLVENTUS GROUP';
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="600" class="email-container" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td class="content-padding" style="padding: 40px 30px;">
              ...
              <p style="color: #374151; font-size: 16px; line-height: 1.5; margin: 0 0 20px 0;">
                ${language === 'en' 
                  ? 'We received a request to reset your password for your SOLVENTUS GROUP account.'
                  : 'Nous avons reçu une demande de réinitialisation du mot de passe pour votre compte SOLVENTUS GROUP.'}
              </p>
                ...
                <tr>
                  <td align="center">
                    <p style="margin: 0; font-size: 12px; color: #64748b; font-family: Arial, sans-serif;">
                      &copy; ${currentYear} SOLVENTUS GROUP. ${language === 'en' ? 'All rights reserved' : 'Tous droits réservés'}.
                    </p>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td class="content-padding" style="padding: 40px 30px;">
              ...
              <p style="color: #6b7280; font-size: 13px; margin: 30px 0 0 0; padding-top: 20px; border-top: 1px solid #e5e7eb;">
                Ce message a été envoyé depuis le formulaire de contact du site Solventus Group.
              </p>
            </td>
          </tr>
          <tr>
            <td align="center" style="background-color: #f8fafc; padding: 30px 20px; border-top: 1px solid #e2e8f0;">
              <table cellpadding="0" cellspacing="0" border="0" width="100%">
                ...
                <tr>
                  <td align="center">
                    <p style="margin: 0; font-size: 12px; color: #64748b; font-family: Arial, sans-serif;">
                      &copy; ${currentYear} SOLVENTUS GROUP. Tous droits réservés.
                    </p>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td style="background-color: #f9fafb; padding: 30px; text-align: center; border-top: 1px solid #e5e7eb;">
              <p style="color: #6b7280; font-size: 14px; margin: 0;">
                SOLVENTUS GROUP - ${language === 'en' ? 'Financing Solutions' : 'Solutions de financement'}<br>
                ${new Date().getFullYear()} ${language === 'en' ? 'All rights reserved' : 'Tous droits réservés'}.
              </p>
            </td>
          </tr>
...
export async function sendOTPEmail(
  ...
  try {
    ...
    const subject = language === 'en' 
      ? 'Your verification code - SOLVENTUS GROUP'
      : 'Votre code de vérification - SOLVENTUS GROUP';
